...
var map__16013 = top_item;
var map__16013__$1 = cljs.core.__destructure_map(map__16013);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16013__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e16012){var _e = e16012;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___16050 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___16050)){
var seen_errors_16051 = temp__5802__auto___16050;
if(cljs.core.truth_(seen_errors_16051.has(self))){
} else {
seen_errors_16051.add(self);

var temp__5804__auto___16053 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___16053)){
var sense_16054 = temp__5804__auto___16053;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_16054)].join(''));
} else {
}
}
} else {
