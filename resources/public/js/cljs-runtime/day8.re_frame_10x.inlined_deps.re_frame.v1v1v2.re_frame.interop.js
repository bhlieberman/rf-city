...
return [(function (){var pred__19500 = cljs.core.instance_QMARK_;
var expr__19501 = reactive_val;
if(cljs.core.truth_((pred__19500.cljs$core$IFn$_invoke$arity$2 ? pred__19500.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__19501) : pred__19500.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__19501)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19500.cljs$core$IFn$_invoke$arity$2 ? pred__19500.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__19501) : pred__19500.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__19501)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19500.cljs$core$IFn$_invoke$arity$2 ? pred__19500.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__19501) : pred__19500.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__19501)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19500.cljs$core$IFn$_invoke$arity$2 ? pred__19500.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__19501) : pred__19500.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__19501)))){
return "tr";
} else {
return "other";
}
