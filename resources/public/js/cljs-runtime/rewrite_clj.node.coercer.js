...
var G__26968 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__26969 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__26968;
lines = G__26969;
continue;
} else {
...
var comma_26971 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_26972 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_26971),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__26955){
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_26972,rewrite_clj.node.protocols.coerce(v),comma_26971);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__26960 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__26960) : f.call(null,G__26960));
})(),sq);
});
