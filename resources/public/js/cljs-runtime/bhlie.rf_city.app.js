...
bhlie.rf_city.app.nav = (function bhlie$rf_city$app$nav(p__41688){
var map__41689 = p__41688;
var map__41689__$1 = cljs.core.__destructure_map(map__41689);
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41689__$1,new cljs.core.Keyword(null,"router","router",1091916230));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.app_bar.app_bar,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"top-banner","top-banner",2032563138),new cljs.core.Keyword(null,"position","position",-2011731912),new cljs.core.Keyword(null,"static","static",1214358571)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.container.container,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-width","max-width",-1939924051),"xl"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.toolbar.toolbar,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.box.box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"sx","sx",-403071592),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"flex-grow","flex-grow",1865160747),(1),new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"xs","xs",649443341),"none",new cljs.core.Keyword(null,"md","md",707286655),"flex"], null)], null)], null),(function (){var iter__5523__auto__ = (function bhlie$rf_city$app$nav_$_iter__41690(s__41691){
return (new cljs.core.LazySeq(null,(function (){
var s__41691__$1 = s__41691;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__41691__$1);
if(temp__5804__auto__){
var s__41691__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41691__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__41691__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__41693 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__41692 = (0);
while(true){
if((i__41692 < size__5522__auto__)){
var route_name = cljs.core._nth(c__5521__auto__,i__41692);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41693),bhlie$rf_city$app$nav_$_iter__41690(cljs.core.chunk_rest(s__41691__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41693),null);
}
} else {
var route_name = cljs.core.first(s__41691__$2);
var route = reitit.core.match_by_name(router,route_name);
var text = new cljs.core.Keyword(null,"link-text","link-text",224432076).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(route));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.button.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"route-link","route-link",-1778351466),new cljs.core.Keyword(null,"key","key",-1516042587),route_name,new cljs.core.Keyword(null,"sx","sx",-403071592),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"my","my",-1055703269),(2),new cljs.core.Keyword(null,"color","color",1011675173),"white",new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.Keyword(null,"block","block",664686210)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$1(route_name)], null),text], null)], null),bhlie$rf_city$app$nav_$_iter__41690(cljs.core.rest(s__41691__$2)));
}
} else {
return null;
}
...
bhlie.rf_city.app.router_component = (function bhlie$rf_city$app$router_component(p__41709){
var map__41710 = p__41709;
var map__41710__$1 = cljs.core.__destructure_map(map__41710);
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41710__$1,new cljs.core.Keyword(null,"router","router",1091916230));
