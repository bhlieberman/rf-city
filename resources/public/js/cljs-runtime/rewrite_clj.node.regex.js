...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26493,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26493,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__26543){
var vec__26551 = p__26543;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26551,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26551,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26492){
var self__ = this;
var G__26492__$1 = this;
return (new cljs.core.RecordIter((0),G__26492__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26496,other26497){
var self__ = this;
var this26496__$1 = this;
return (((!((other26497 == null)))) && ((((this26496__$1.constructor === other26497.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26496__$1.pattern,other26497.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26496__$1.__extmap,other26497.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26493){
var self__ = this;
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26492){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26596 = cljs.core.keyword_identical_QMARK_;
var expr__26597 = k__5352__auto__;
if(cljs.core.truth_((pred__26596.cljs$core$IFn$_invoke$arity$2 ? pred__26596.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__26597) : pred__26596.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__26597)))){
return (new rewrite_clj.node.regex.RegexNode(G__26492,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26492),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26492){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__26492,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__26510){
var extmap__5385__auto__ = (function (){var G__26620 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__26510,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_(G__26510)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26620);
} else {
return G__26620;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__26510),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
