...
var len__5769__auto___16215 = arguments.length;
var i__5770__auto___16216 = (0);
while(true){
if((i__5770__auto___16216 < len__5769__auto___16215)){
args__5775__auto__.push((arguments[i__5770__auto___16216]));

var G__16217 = (i__5770__auto___16216 + (1));
i__5770__auto___16216 = G__16217;
continue;
} else {
}
break;
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16153,G__16154,seq16152__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16171_SHARP_){
return (!((cljs.core.meta(p1__16171_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16180__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16181){var _e__15264__auto__ = e16181;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e16185){var _e__15264__auto__ = e16185;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__16193 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16194 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16194);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16197__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16193);
}});
...
var temp__5802__auto___16229 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___16229)){
var managed_print_level_16234 = temp__5802__auto___16229;
var _STAR_print_level_STAR__orig_val__16205_16235 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16206_16236 = managed_print_level_16234;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16206_16236);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__16201_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__16201_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16205_16235);
}} else {
job_fn();
}
