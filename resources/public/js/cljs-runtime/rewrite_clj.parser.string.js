...
if((c === "\n")){
var G__26725 = escape_QMARK_;
var G__26726 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__26725;
lines = G__26726;
continue;
} else {
buf.append(c);

var G__26727 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__26728 = lines;
escape_QMARK_ = G__26727;
lines = G__26728;
continue;
