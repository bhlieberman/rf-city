...
var i__5770__auto___26753 = (0);
while(true){
if((i__5770__auto___26753 < len__5769__auto___26752)){
args__5775__auto__.push((arguments[i__5770__auto___26753]));

var G__26754 = (i__5770__auto___26753 + (1));
i__5770__auto___26753 = G__26754;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__26733){
var vec__26735 = p__26733;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26735,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__26729_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__26729_SHARP_) : allowed_QMARK_.call(null,p1__26729_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__26729_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq26730){
var G__26731 = cljs.core.first(seq26730);
var seq26730__$1 = cljs.core.next(seq26730);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26731,seq26730__$1);
}));
