...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26503,else__5346__auto__){
var self__ = this;
...
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26561,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26561,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26502){
var self__ = this;
var G__26502__$1 = this;
return (new cljs.core.RecordIter((0),G__26502__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26504,other26505){
var self__ = this;
var this26504__$1 = this;
return (((!((other26505 == null)))) && ((((this26504__$1.constructor === other26505.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26504__$1.tag,other26505.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26504__$1.prefix,other26505.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26504__$1.sym,other26505.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26504__$1.children,other26505.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26504__$1.__extmap,other26505.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26503){
var self__ = this;
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26502){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26617 = cljs.core.keyword_identical_QMARK_;
var expr__26618 = k__5352__auto__;
if(cljs.core.truth_((pred__26617.cljs$core$IFn$_invoke$arity$2 ? pred__26617.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__26618) : pred__26617.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__26618)))){
return (new rewrite_clj.node.quote.QuoteNode(G__26502,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26617.cljs$core$IFn$_invoke$arity$2 ? pred__26617.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__26618) : pred__26617.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__26618)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__26502,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26617.cljs$core$IFn$_invoke$arity$2 ? pred__26617.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__26618) : pred__26617.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__26618)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__26502,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26617.cljs$core$IFn$_invoke$arity$2 ? pred__26617.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__26618) : pred__26617.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__26618)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__26502,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26502),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26502){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__26502,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__26513){
var extmap__5385__auto__ = (function (){var G__26644 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26513,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__26513)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26644);
} else {
return G__26644;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__26513),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__26513),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__26513),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__26513),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__26691 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__26691;
continue;
}
break;
...
var G__26692 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__26692;
continue;
}
break;
...
var G__26693 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__26693;
continue;
}
break;
...
var G__26694 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__26694;
continue;
}
break;
