...
var periods__$1 = cljs.core.vec((function (){var G__33710 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33709_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__33709_SHARP_,(0),(3));
}),G__33710);
} else {
return G__33710;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__33737){
var vec__33738 = p__33737;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33738,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33738,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__33741 = pattern;
switch (G__33741) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33741)].join('')));
...
return p1__33742_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__33743_SHARP_){
return p1__33743_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__33744_SHARP_){
return p1__33744_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__33745_SHARP_){
return p1__33745_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__33746_SHARP_){
return p1__33746_SHARP_.getHours();
});

break;
case "day":
return (function (p1__33747_SHARP_){
return p1__33747_SHARP_.getDate();
});

break;
case "month":
return (function (p1__33748_SHARP_){
return p1__33748_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__33749_SHARP_){
return p1__33749_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__33751){
...
var key = first__33754;
var args = seq__33753__$1;
var G__33755 = key;
...
break;
case "ordinal-suffix":
var vec__33756 = (function (){var G__33759 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__33759) : syntax_list.call(null,G__33759));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33755__$1)].join('')));
...
var d = value;
var G__33763 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__33764 = G__33763;
...
var unparser = first__33766;
var more = seq__33765__$1;
var s = "";
var d__$1 = d;
...
var unparser__$1 = first__33775;
var more__$1 = seq__33774__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__33776 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33776,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33776,(1),null);
var G__33795 = d__$3;
var G__33796 = more__$1;
var G__33797 = s__$3;
d__$1 = G__33795;
G__33763__$1 = G__33796;
s__$1 = G__33797;
continue;
}
break;
