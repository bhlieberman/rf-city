...
16,1.75,.15),subtitle2:typography(fontWeightMedium,14,1.57,.1),body1:typography(fontWeightRegular,16,1.5,.15),body2:typography(fontWeightRegular,14,1.43,.15),button:typography(fontWeightMedium,14,1.75,.4,caseAllCaps),caption:typography(fontWeightRegular,12,1.66,.4),overline:typography(fontWeightRegular,12,2.66,1,caseAllCaps),inherit:{fontFamily:"inherit",fontWeight:"inherit",fontSize:"inherit",lineHeight:"inherit",letterSpacing:"inherit"}};return(0,_utils.deepmerge)((0,_extends2.default)({htmlFontSize,
pxToRem,fontFamily,fontSize,fontWeightLight,fontWeightRegular,fontWeightMedium,fontWeightBold},typography),palette,{clone:!1})};var _extends2=global(require("module$node_modules$$babel$runtime$helpers$extends")),_objectWithoutPropertiesLoose2=global(require("module$node_modules$$babel$runtime$helpers$objectWithoutPropertiesLoose")),_utils=require("module$node_modules$$mui$utils$index");const _excluded="fontFamily fontSize fontWeightLight fontWeightRegular fontWeightMedium fontWeightBold htmlFontSize allVariants pxToRem".split(" "),
