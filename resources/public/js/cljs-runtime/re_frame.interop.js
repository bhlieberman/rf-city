...
return [(function (){var pred__15596 = cljs.core.instance_QMARK_;
var expr__15597 = reactive_val;
if(cljs.core.truth_((pred__15596.cljs$core$IFn$_invoke$arity$2 ? pred__15596.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__15597) : pred__15596.call(null,reagent.ratom.RAtom,expr__15597)))){
return "ra";
} else {
if(cljs.core.truth_((pred__15596.cljs$core$IFn$_invoke$arity$2 ? pred__15596.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__15597) : pred__15596.call(null,reagent.ratom.RCursor,expr__15597)))){
return "rc";
} else {
if(cljs.core.truth_((pred__15596.cljs$core$IFn$_invoke$arity$2 ? pred__15596.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__15597) : pred__15596.call(null,reagent.ratom.Reaction,expr__15597)))){
return "rx";
} else {
if(cljs.core.truth_((pred__15596.cljs$core$IFn$_invoke$arity$2 ? pred__15596.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__15597) : pred__15596.call(null,reagent.ratom.Track,expr__15597)))){
return "tr";
} else {
return "other";
}
