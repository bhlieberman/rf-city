...
var G__25470 = clojure.zip.node(loc);
var fexpr__25469 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__25469.cljs$core$IFn$_invoke$arity$1 ? fexpr__25469.cljs$core$IFn$_invoke$arity$1(G__25470) : fexpr__25469.call(null,G__25470));
});
/**
...
var G__25472 = clojure.zip.node(loc);
var fexpr__25471 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__25471.cljs$core$IFn$_invoke$arity$1 ? fexpr__25471.cljs$core$IFn$_invoke$arity$1(G__25472) : fexpr__25471.call(null,G__25472));
} else {
...
var fexpr__25477 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__25477.cljs$core$IFn$_invoke$arity$2 ? fexpr__25477.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__25477.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__25489 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25489,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25489,(1),null);
var vec__25492 = clojure.zip.children(loc);
...
var vec__25500 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25500,(0),null);
var map__25503 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25500,(1),null);
var map__25503__$1 = cljs.core.__destructure_map(map__25503);
var path = map__25503__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25503__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25503__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25503__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25503__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25503__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__25515 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25515,(0),null);
var map__25518 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25515,(1),null);
var map__25518__$1 = cljs.core.__destructure_map(map__25518);
var path = map__25518__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25518__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__25519 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25518__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__25522 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25522,(0),null);
var map__25525 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25522,(1),null);
var map__25525__$1 = cljs.core.__destructure_map(map__25525);
var path = map__25525__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25525__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25525__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var map__25532 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25529,(1),null);
var map__25532__$1 = cljs.core.__destructure_map(map__25532);
var path = map__25532__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25532__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25532__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__25536 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25536,(0),null);
var map__25539 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25536,(1),null);
var map__25539__$1 = cljs.core.__destructure_map(map__25539);
var path = map__25539__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25539__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25539__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__25544 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25544,(0),null);
var map__25547 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25544,(1),null);
var map__25547__$1 = cljs.core.__destructure_map(map__25547);
var path = map__25547__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25547__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__25549 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25549,(0),null);
var map__25552 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25549,(1),null);
var map__25552__$1 = cljs.core.__destructure_map(map__25552);
var path = map__25552__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25552__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25561,(1),null);
...
var len__5769__auto___25681 = arguments.length;
var i__5770__auto___25682 = (0);
while(true){
if((i__5770__auto___25682 < len__5769__auto___25681)){
args__5775__auto__.push((arguments[i__5770__auto___25682]));

var G__25683 = (i__5770__auto___25682 + (1));
i__5770__auto___25682 = G__25683;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq25573){
var G__25574 = cljs.core.first(seq25573);
var seq25573__$1 = cljs.core.next(seq25573);
var G__25575 = cljs.core.first(seq25573__$1);
var seq25573__$2 = cljs.core.next(seq25573__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25574,G__25575,seq25573__$2);
}));
...
var G__25685 = clojure.zip.rightmost(child);
loc__$1 = G__25685;
continue;
} else {
return loc__$1;
...
var vec__25613 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25613,(0),null);
var map__25616 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25613,(1),null);
var map__25616__$1 = cljs.core.__destructure_map(map__25616);
var path = map__25616__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25616__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25616__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25616__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25616__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__25687 = clojure.zip.rightmost(child);
loc__$1 = G__25687;
continue;
} else {
return loc__$1;
