...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__25478_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__25478_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__25478_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__25485){
var vec__25486 = p__25485;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25486,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25486,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__25495,s,color,element,idx){
var map__25496 = p__25495;
var map__25496__$1 = cljs.core.__destructure_map(map__25496);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25496__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25496__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25496__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__25505 = (function (){var or__5045__auto__ = color;
...
var fexpr__25504 = (function (){var G__25506 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__25506) : style_map.call(null,G__25506));
})();
return (fexpr__25504.cljs$core$IFn$_invoke$arity$1 ? fexpr__25504.cljs$core$IFn$_invoke$arity$1(G__25505) : fexpr__25504.call(null,G__25505));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__25507){
var vec__25508 = p__25507;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25508,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25508,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25508,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__25511){
var vec__25512 = p__25511;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25512,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25512,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25512,(2),null);
...
var G__25722 = cljs.core.next(ssv);
var G__25723 = (this_ssv == null);
var G__25724 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__25725 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__25722;
doing_nil_QMARK_ = G__25723;
last_elide = G__25724;
out = G__25725;
continue;
}
...
var vec__25577 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25577,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25577,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25577,(2),null);
...
var G__25726 = cljs.core.next(remaining_cvec);
var G__25727 = new_idx;
var G__25728 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__25726;
idx = G__25727;
out = G__25728;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__25629,cursor_vec){
var vec__25630 = p__25629;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25630,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25630,(1),null);
var focus_vec = vec__25630;
...
var vec__25638 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25638,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25638,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__25644){
var vec__25645 = p__25644;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25645,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25645,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__25668,existing_count){
var vec__25669 = p__25668;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25669,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25669,(1),null);
...
return cljs.core.filterv((function (p1__25655_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__25655_SHARP_))));
...
var vec__25694 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25694,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25694,(1),null);
var cvec_element = vec__25694;
if((cvec_element == null)){
var G__25738 = cljs.core.next(cvec_nl);
var G__25739 = (idx + (1));
var G__25740 = start;
var G__25741 = out;
cvec_nl = G__25738;
...
var G__25742 = cljs.core.next(cvec_nl);
var G__25743 = (idx + (1));
var G__25744 = idx;
var G__25745 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__25742;
idx = G__25743;
start = G__25744;
out = G__25745;
...
var G__25746 = cljs.core.next(cvec_nl);
var G__25747 = (idx + (1));
var G__25748 = (idx + (1));
var G__25749 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__25746;
idx = G__25747;
start = G__25748;
out = G__25749;
...
var G__25750 = cljs.core.next(cvec_nl);
var G__25751 = (idx + (1));
var G__25752 = idx;
var G__25753 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__25750;
idx = G__25751;
start = G__25752;
out = G__25753;
...
var G__25754 = cljs.core.next(cvec_nl);
var G__25755 = (idx + (1));
var G__25756 = start;
var G__25757 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__25754;
idx = G__25755;
start = G__25756;
out = G__25757;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__25698_SHARP_,p2__25697_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__25697_SHARP_)){
return cljs.core.reduced(p1__25698_SHARP_);
} else {
return (p1__25698_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__25700,p__25701){
var vec__25705 = p__25700;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25705,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25705,(1),null);
var vec__25708 = p__25701;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25708,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25708,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__25717,cvec,focus_vec){
var map__25718 = p__25717;
var map__25718__$1 = cljs.core.__destructure_map(map__25718);
var options = map__25718__$1;
var map__25719 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25718__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__25719__$1 = cljs.core.__destructure_map(map__25719);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25719__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25719__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25719__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25716_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__25716_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
