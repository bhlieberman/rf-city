...
scrollTop:tabsNode.scrollTop,scrollLeftNormalized:(0,_scrollLeft.getNormalizedScrollLeft)(tabsNode,theme.direction),scrollWidth:tabsNode.scrollWidth,top:tabsMeta.top,bottom:tabsMeta.bottom,left:tabsMeta.left,right:tabsMeta.right}}var tabMeta;tabsNode&&!1!==value&&(tabsNode=tabListRef.current.children,0<tabsNode.length&&((tabMeta=tabsNode[valueToIndex.get(value)])||console.error(["MUI: The `value` provided to the Tabs component is invalid.",`None of the Tabs' children match with "${value}".`,valueToIndex.keys?
`You can provide one of the following values: ${Array.from(valueToIndex.keys()).join(", ")}.`:null].join("\n")),tabMeta=tabMeta?tabMeta.getBoundingClientRect():null,!warnedOnceTabPresent&&tabMeta&&0===tabMeta.width&&0===tabMeta.height&&0!==tabsMeta.clientWidth&&(tabsMeta=null,console.error(["MUI: The `value` provided to the Tabs component is invalid.",`The Tab with this \`value\` ("${value}") is not part of the document layout.`,"Make sure the tab item is present in the document or that it's not `display: none`."].join("\n")),
warnedOnceTabPresent=!0)));return{tabsMeta,tabMeta}},updateIndicatorState=(0,_useEventCallback.default)(()=>{const {tabsMeta,tabMeta}=getTabsMeta();var startValue=0;let startIndicator;vertical?(startIndicator="top",tabMeta&&tabsMeta&&(startValue=tabMeta.top-tabsMeta.top+tabsMeta.scrollTop)):(startIndicator=isRtl?"right":"left",tabMeta&&tabsMeta&&(startValue=(isRtl?-1:1)*(tabMeta[startIndicator]-tabsMeta[startIndicator]+(isRtl?tabsMeta.scrollLeftNormalized+tabsMeta.clientWidth-tabsMeta.scrollWidth:
tabsMeta.scrollLeft))));startValue={[startIndicator]:startValue,[size]:tabMeta?tabMeta[size]:0};if(isNaN(indicatorStyle[startIndicator])||isNaN(indicatorStyle[size]))setIndicatorStyle(startValue);else{const dSize=Math.abs(indicatorStyle[size]-startValue[size]);(1<=Math.abs(indicatorStyle[startIndicator]-startValue[startIndicator])||1<=dSize)&&setIndicatorStyle(startValue)}}),scroll=(scrollValue,{animation=!0}={})=>{animation?(0,_animate.default)(scrollStart,tabsRef.current,scrollValue,{duration:theme.transitions.duration.standard}):
tabsRef.current[scrollStart]=scrollValue},moveTabsScroll=delta=>{let scrollValue=tabsRef.current[scrollStart];vertical?scrollValue+=delta:(scrollValue+=delta*(isRtl?-1:1),scrollValue*=isRtl&&"reverse"===(0,_scrollLeft.detectScrollType)()?-1:1);scroll(scrollValue)},getScrollSize=()=>{const containerSize=tabsRef.current[clientSize];let totalSize=0;const children=Array.from(tabListRef.current.children);for(let i=0;i<children.length;i+=1){const tab=children[i];if(totalSize+tab[clientSize]>containerSize){0===
i&&(totalSize=containerSize);break}totalSize+=tab[clientSize]}return totalSize},handleStartScrollClick=()=>{moveTabsScroll(-1*getScrollSize())},handleEndScrollClick=()=>{moveTabsScroll(getScrollSize())},handleScrollbarSizeChange=React.useCallback(scrollbarWidth=>{setScrollerStyle({overflow:null,scrollbarWidth})},[]),scrollSelectedIntoView=(0,_useEventCallback.default)(animation=>{const {tabsMeta,tabMeta}=getTabsMeta();tabMeta&&tabsMeta&&(tabMeta[start]<tabsMeta[start]?scroll(tabsMeta[scrollStart]+
(tabMeta[start]-tabsMeta[start]),{animation}):tabMeta[end]>tabsMeta[end]&&scroll(tabsMeta[scrollStart]+(tabMeta[end]-tabsMeta[end]),{animation}))}),updateScrollButtonState=(0,_useEventCallback.default)(()=>{if(scrollable&&!1!==scrollButtons){const {scrollTop,scrollHeight,clientHeight,scrollWidth,clientWidth}=tabsRef.current;let showStartScroll;if(vertical){showStartScroll=1<scrollTop;var showEndScroll=scrollTop<scrollHeight-clientHeight-1}else showEndScroll=(0,_scrollLeft.getNormalizedScrollLeft)(tabsRef.current,
theme.direction),showStartScroll=isRtl?showEndScroll<scrollWidth-clientWidth-1:1<showEndScroll,showEndScroll=isRtl?1<showEndScroll:showEndScroll<scrollWidth-clientWidth-1;showStartScroll===displayScroll.start&&showEndScroll===displayScroll.end||setDisplayScroll({start:showStartScroll,end:showEndScroll})}});React.useEffect(()=>{const handleResize=(0,_debounce.default)(()=>{tabsRef.current&&(updateIndicatorState(),updateScrollButtonState())}),win=(0,_ownerWindow.default)(tabsRef.current);win.addEventListener("resize",
handleResize);let resizeObserver;"undefined"!==typeof ResizeObserver&&(resizeObserver=new ResizeObserver(handleResize),Array.from(tabListRef.current.children).forEach(child=>{resizeObserver.observe(child)}));return()=>{handleResize.clear();win.removeEventListener("resize",handleResize);resizeObserver&&resizeObserver.disconnect()}},[updateIndicatorState,updateScrollButtonState]);const handleTabsScroll=React.useMemo(()=>(0,_debounce.default)(()=>{updateScrollButtonState()}),[updateScrollButtonState]);
React.useEffect(()=>()=>{handleTabsScroll.clear()},[handleTabsScroll]);React.useEffect(()=>{setMounted(!0)},[]);React.useEffect(()=>{updateIndicatorState();updateScrollButtonState()});React.useEffect(()=>{scrollSelectedIntoView(defaultIndicatorStyle!==indicatorStyle)},[scrollSelectedIntoView,indicatorStyle]);React.useImperativeHandle(action,()=>({updateIndicator:updateIndicatorState,updateScrollButtons:updateScrollButtonState}),[updateIndicatorState,updateScrollButtonState]);const indicator=(0,_jsxRuntime.jsx)(TabsIndicator,
(0,_extends2.default)({},TabIndicatorProps,{className:(0,_clsx.default)(classes.indicator,TabIndicatorProps.className),ownerState:props,style:(0,_extends2.default)({},indicatorStyle,TabIndicatorProps.style)}));let childIndex=0;const children$jscomp$0=React.Children.map(childrenProp,child=>{if(!React.isValidElement(child))return null;(0,_reactIs.isFragment)(child)&&console.error("MUI: The Tabs component doesn't accept a Fragment as a child.\nConsider providing an array instead.");const childValue=
...
{className:classes.scroller,ownerState:props,style:{overflow:scrollerStyle.overflow,[vertical?`margin${isRtl?"Left":"Right"}`:"marginBottom"]:visibleScrollbar?void 0:-scrollerStyle.scrollbarWidth},ref:tabsRef,onScroll:handleTabsScroll,children:[(0,_jsxRuntime.jsx)(FlexContainer,{"aria-label":ariaLabel,"aria-labelledby":ariaLabelledBy,"aria-orientation":"vertical"===orientation?"vertical":null,className:classes.flexContainer,ownerState:props,onKeyDown:event=>{const list=tabListRef.current,currentFocus=
(0,_ownerDocument.default)(list).activeElement;if("tab"===currentFocus.getAttribute("role")){var previousItemKey="horizontal"===orientation?"ArrowLeft":"ArrowUp",nextItemKey="horizontal"===orientation?"ArrowRight":"ArrowDown";"horizontal"===orientation&&isRtl&&(previousItemKey="ArrowRight",nextItemKey="ArrowLeft");switch(event.key){case previousItemKey:event.preventDefault();moveFocus(list,currentFocus,previousItem);break;case nextItemKey:event.preventDefault();moveFocus(list,currentFocus,nextItem);
break;case "Home":event.preventDefault();moveFocus(list,null,nextItem);break;case "End":event.preventDefault(),moveFocus(list,null,previousItem)}}},ref:tabListRef,role:"tablist",children:children$jscomp$0}),mounted&&indicator]}),conditionalElements.scrollButtonEnd]}))});require.propTypes={action:module.refType,allowScrollButtonsMobile:global.default.bool,"aria-label":global.default.string,"aria-labelledby":global.default.string,centered:global.default.bool,children:global.default.node,classes:global.default.object,
className:global.default.string,component:global.default.elementType,indicatorColor:global.default.oneOfType([global.default.oneOf(["primary","secondary"]),global.default.string]),onChange:global.default.func,orientation:global.default.oneOf(["horizontal","vertical"]),ScrollButtonComponent:global.default.elementType,scrollButtons:global.default.oneOf(["auto",!1,!0]),selectionFollowsFocus:global.default.bool,slotProps:global.default.shape({endScrollButtonIcon:global.default.oneOfType([global.default.func,
global.default.object]),startScrollButtonIcon:global.default.oneOfType([global.default.func,global.default.object])}),slots:global.default.shape({EndScrollButtonIcon:global.default.elementType,StartScrollButtonIcon:global.default.elementType}),sx:global.default.oneOfType([global.default.arrayOf(global.default.oneOfType([global.default.func,global.default.object,global.default.bool])),global.default.func,global.default.object]),TabIndicatorProps:global.default.object,TabScrollButtonProps:global.default.object,
textColor:global.default.oneOf(["inherit","primary","secondary"]),value:global.default.any,variant:global.default.oneOf(["fullWidth","scrollable","standard"]),visibleScrollbar:global.default.bool};exports.default=require}
