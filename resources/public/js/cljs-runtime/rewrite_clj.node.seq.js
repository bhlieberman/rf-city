...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26499,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26499,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__26545){
var vec__26557 = p__26545;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26557,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26557,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26498){
var self__ = this;
var G__26498__$1 = this;
return (new cljs.core.RecordIter((0),G__26498__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26500,other26501){
var self__ = this;
var this26500__$1 = this;
return (((!((other26501 == null)))) && ((((this26500__$1.constructor === other26501.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26500__$1.tag,other26501.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26500__$1.format_string,other26501.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26500__$1.wrap_length,other26501.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26500__$1.seq_fn,other26501.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26500__$1.children,other26501.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26500__$1.__extmap,other26501.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__26595 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__26595) : self__.seq_fn.call(null,G__26595));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26499){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k26499);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26498){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26621 = cljs.core.keyword_identical_QMARK_;
var expr__26622 = k__5352__auto__;
if(cljs.core.truth_((pred__26621.cljs$core$IFn$_invoke$arity$2 ? pred__26621.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__26622) : pred__26621.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__26622)))){
return (new rewrite_clj.node.seq.SeqNode(G__26498,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26621.cljs$core$IFn$_invoke$arity$2 ? pred__26621.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__26622) : pred__26621.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__26622)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__26498,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26621.cljs$core$IFn$_invoke$arity$2 ? pred__26621.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__26622) : pred__26621.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__26622)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__26498,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26621.cljs$core$IFn$_invoke$arity$2 ? pred__26621.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__26622) : pred__26621.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__26622)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__26498,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26621.cljs$core$IFn$_invoke$arity$2 ? pred__26621.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__26622) : pred__26621.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__26622)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__26498,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26498),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26498){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__26498,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__26514){
var extmap__5385__auto__ = (function (){var G__26646 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26514,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__26514)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26646);
} else {
return G__26646;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__26514),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__26514),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__26514),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__26514),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__26514),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__26653_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__26653_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__26662_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__26662_SHARP_);
}),children);
});
