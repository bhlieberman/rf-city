...
rewrite_clj.node.keyword.keyword_sexpr = (function rewrite_clj$node$keyword$keyword_sexpr(kw,kw_auto_resolved_QMARK_,map_qualifier,p__26525){
var map__26526 = p__26525;
var map__26526__$1 = cljs.core.__destructure_map(map__26526);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26526__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
...
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var G__26533 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__26537 = (function (){var or__5045__auto__ = (function (){var G__26540 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__26540 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__26540);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
var fexpr__26536 = (function (){var or__5045__auto__ = auto_resolve;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return (fexpr__26536.cljs$core$IFn$_invoke$arity$1 ? fexpr__26536.cljs$core$IFn$_invoke$arity$1(G__26537) : fexpr__26536.call(null,G__26537));
})():new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q));
if((G__26533 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26533);
}
})(),cljs.core.name(kw));
});
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26569,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26569,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__26585){
var vec__26587 = p__26585;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26587,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26587,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26570,other26571){
var self__ = this;
var this26570__$1 = this;
return (((!((other26571 == null)))) && ((((this26570__$1.constructor === other26571.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26570__$1.k,other26571.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26570__$1.auto_resolved_QMARK_,other26571.auto_resolved_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26570__$1.map_qualifier,other26571.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26570__$1.__extmap,other26571.__extmap)))))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26569){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k26569);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26568){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26639 = cljs.core.keyword_identical_QMARK_;
var expr__26640 = k__5352__auto__;
if(cljs.core.truth_((pred__26639.cljs$core$IFn$_invoke$arity$2 ? pred__26639.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__26640) : pred__26639.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__26640)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__26568,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26639.cljs$core$IFn$_invoke$arity$2 ? pred__26639.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__26640) : pred__26639.call(null,new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__26640)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__26568,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26639.cljs$core$IFn$_invoke$arity$2 ? pred__26639.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__26640) : pred__26639.call(null,new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__26640)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,G__26568,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26568),null));
}
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26568){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,G__26568,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__26581){
var extmap__5385__auto__ = (function (){var G__26660 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26581,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
if(cljs.core.record_QMARK_(G__26581)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26660);
} else {
return G__26660;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__26581),new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(G__26581),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__26581),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
