...
var G__28582 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__28582__$1 = (((G__28582 == null))?null:cljs.core.iterate((function (loc){
...
var G__28582__$2 = (((G__28582__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__28582__$1));
var G__28582__$3 = (((G__28582__$2 == null))?null:cljs.core.last(G__28582__$2));
if((G__28582__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__28582__$3);
}
} else {
return zloc;
}
...
var G__28624 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__28625 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__28624;
parent = G__28625;
continue;
} else {
var G__28629 = rewrite_clj.zip.move.right(zloc_map_value);
var G__28630 = parent;
loc = G__28629;
parent = G__28630;
continue;
...
var G__28639 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__28640 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__28639;
parent = G__28640;
continue;
} else {
var G__28641 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__28642 = parent;
loc = G__28641;
parent = G__28642;
continue;
...
var G__28597 = zloc;
var G__28597__$1 = (((G__28597 == null))?null:rewrite_clj.zip.move.down(G__28597));
var G__28597__$2 = (((G__28597__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__28597__$1,k));
if((G__28597__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__28597__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__28602 = zloc;
var G__28602__$1 = (((G__28602 == null))?null:rewrite_clj.zip.move.down(G__28602));
var G__28602__$2 = (((G__28602__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__28602__$1));
var G__28602__$3 = (((G__28602__$2 == null))?null:rewrite_clj.zip.move.down(G__28602__$2));
var G__28602__$4 = (((G__28602__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__28602__$3,k));
if((G__28602__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__28602__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__28603 = rewrite_clj.zip.move.down(zloc);
var G__28603__$1 = (((G__28603 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__28603));
if((G__28603__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__28603__$1);
}
})(),k);
