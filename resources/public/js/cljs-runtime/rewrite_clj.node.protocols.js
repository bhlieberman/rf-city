...
var rewrite_clj$node$protocols$Node$tag$dyn_25778 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_25778(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_25779 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_25779(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_25829 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_25829(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_25831 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_25831(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_25833 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_25833(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_25840 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_25840(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25713_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__25713_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_25860 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_25860(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_25863 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_25863(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_25909 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_25909(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_25917 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_25917(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_25922 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_25922(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_25926 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_25926(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_25933 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_25933(node);
}
});
...
var map__25766 = cljs.core.meta(node);
var map__25766__$1 = cljs.core.__destructure_map(map__25766);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25766__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25766__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25766__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25766__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__25767,p__25768){
var vec__25769 = p__25767;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25769,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25769,(1),null);
var vec__25772 = p__25768;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25772,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25772,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__25775 = col_extent;
if((row_extent === (0))){
return (G__25775 + col);
} else {
return G__25775;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__25776 = rewrite_clj.node.protocols.children(node);
var G__25776__$1 = (((G__25776 == null))?null:cljs.core.first(G__25776));
if((G__25776__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__25776__$1);
}
} else {
