...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__28703_SHARP_){
var G__28704 = rewrite_clj.custom_zipper.core.node(p1__28703_SHARP_);
if((!((G__28704 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__28704.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__28704.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__28704);
} else {
return false;
}
}
