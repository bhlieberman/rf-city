...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_52913 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_52913(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_52914 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_52914(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_52915 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_52915(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_52916 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_52916(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_52917 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_52917(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_52918 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_52918(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_52919 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_52919(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_52924 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_52924(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_52926 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_52926(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_52928 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_52928(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k52785,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__52800 = k52785;
var G__52800__$1 = (((G__52800 instanceof cljs.core.Keyword))?G__52800.fqn:null);
switch (G__52800__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52785,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__52805){
var vec__52806 = p__52805;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52806,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52806,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__52784){
var self__ = this;
var G__52784__$1 = this;
return (new cljs.core.RecordIter((0),G__52784__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52786,other52787){
var self__ = this;
var this52786__$1 = this;
return (((!((other52787 == null)))) && ((((this52786__$1.constructor === other52787.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52786__$1.status,other52787.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52786__$1.body,other52787.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52786__$1.status_text,other52787.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52786__$1.headers,other52787.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52786__$1.was_aborted,other52787.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52786__$1.__extmap,other52787.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k52785){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k52785);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__52784){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__52844 = cljs.core.keyword_identical_QMARK_;
var expr__52845 = k__5352__auto__;
if(cljs.core.truth_((pred__52844.cljs$core$IFn$_invoke$arity$2 ? pred__52844.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__52845) : pred__52844.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__52845)))){
return (new ajax.protocols.Response(G__52784,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52844.cljs$core$IFn$_invoke$arity$2 ? pred__52844.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__52845) : pred__52844.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__52845)))){
return (new ajax.protocols.Response(self__.status,G__52784,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52844.cljs$core$IFn$_invoke$arity$2 ? pred__52844.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__52845) : pred__52844.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__52845)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__52784,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52844.cljs$core$IFn$_invoke$arity$2 ? pred__52844.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__52845) : pred__52844.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__52845)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__52784,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52844.cljs$core$IFn$_invoke$arity$2 ? pred__52844.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__52845) : pred__52844.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__52845)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__52784,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__52784),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__52784){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__52784,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__52789){
var extmap__5385__auto__ = (function (){var G__52897 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52789,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__52789)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52897);
} else {
return G__52897;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__52789),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__52789),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__52789),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__52789),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__52789),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
