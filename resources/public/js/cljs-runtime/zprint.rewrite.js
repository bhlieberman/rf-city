...
var G__31453 = rewrite_clj.zip.next(n);
loc = G__31453;
continue;
} else {
var G__31454 = rewrite_clj.zip.next(loc);
loc = G__31454;
continue;
}
} else {
var G__31455 = rewrite_clj.zip.next(loc);
loc = G__31455;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__31433 = zloc;
var G__31433__$1 = (((G__31433 == null))?null:rewrite_clj.zip.node(G__31433));
if((G__31433__$1 == null)){
return null;
} else {
return rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__31433__$1);
}
})())));
});
/**
...
var G__31458 = rewrite_clj.zip.down(nloc);
nloc = G__31458;
continue;
}
break;
...
var G__31464 = rewrite_clj.zip.right(nloc);
var G__31465 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__31464;
out = G__31465;
continue;
} else {
...
var G__31468 = rewrite_clj.zip.right(replaced_loc);
var G__31469 = cljs.core.next(new_loc);
var G__31470 = replaced_loc;
nloc = G__31468;
new_loc = G__31469;
last_loc = G__31470;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__31447_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__31447_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__31447_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
