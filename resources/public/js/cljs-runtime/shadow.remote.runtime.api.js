...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_50568 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_50568(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_50570 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_50570(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_50574 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_50574(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_50576 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_50576(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_50582 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_50582(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_50585 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_50585(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__50534,callback){
var map__50535 = p__50534;
var map__50535__$1 = cljs.core.__destructure_map(map__50535);
var input = map__50535__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50535__$1,new cljs.core.Keyword(null,"code","code",1586293142));
