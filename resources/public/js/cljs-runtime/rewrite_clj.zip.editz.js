...
return rewrite_clj.node.protocols.coerce((function (){var G__28527 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__28527) : f.call(null,G__28527));
})());
});
});
/**
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__28528_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__28528_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq28529){
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__28546 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__28546) : str_fn.call(null,G__28546));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__28547 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__28547) : str_fn.call(null,G__28547));
})()):null)));
...
var G__28552 = rewrite_clj.zip.base.tag(zloc);
var G__28552__$1 = (((G__28552 instanceof cljs.core.Keyword))?G__28552.fqn:null);
switch (G__28552__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__28548_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__28548_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__28550_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__28550_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28552__$1)].join('')));
...
var G__28554 = rewrite_clj.zip.base.tag(zloc);
var G__28554__$1 = (((G__28554 instanceof cljs.core.Keyword))?G__28554.fqn:null);
switch (G__28554__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__28553_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__28553_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28554__$1)].join('')));
