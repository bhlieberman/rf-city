...
var day8$re_frame_10x$tools$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_41814 = (function (x){
...
return day8$re_frame_10x$tools$pretty_print_condensed$ILimited$_limited_QMARK_$dyn_41814(x);
}
});
...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__41656 = per_side_budget;
...
var G__41841 = clojure.string.replace(s,match,trunc_prefix);
var G__41842 = limit;
var G__41843 = match;
var G__41844 = trunc_prefix;
s = G__41841;
limit = G__41842;
match = G__41843;
trunc_prefix = G__41844;
continue;
}
}
break;
...
var prefix = (function (){var G__41677 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__41677,"\u2026/"].join('');
} else {
return G__41677;
}
})();
...
var vec__41718 = day8.re_frame_10x.tools.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41718,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41718,(1),null);
...
var or__5045__auto__ = (function (){var G__41732 = form.name;
if((G__41732 == null)){
return null;
} else {
return clojure.string.replace(G__41732,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__41748 = obj;
var G__41749 = writer;
var G__41750 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.tools.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__41748,G__41749,G__41750) : alt_impl.call(null,G__41748,G__41749,G__41750));
} else {
...
var seq__41753 = cljs.core.seq(cljs.core.next(objs));
var chunk__41754 = null;
var count__41755 = (0);
var i__41756 = (0);
while(true){
if((i__41756 < count__41755)){
var obj = chunk__41754.cljs$core$IIndexed$_nth$arity$2(null,i__41756);
cljs.core._write(writer," ");

day8.re_frame_10x.tools.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__41889 = seq__41753;
var G__41890 = chunk__41754;
var G__41891 = count__41755;
var G__41892 = (i__41756 + (1));
seq__41753 = G__41889;
chunk__41754 = G__41890;
count__41755 = G__41891;
i__41756 = G__41892;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__41753);
if(temp__5804__auto__){
var seq__41753__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__41753__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__41753__$1);
var G__41893 = cljs.core.chunk_rest(seq__41753__$1);
var G__41894 = c__5568__auto__;
var G__41895 = cljs.core.count(c__5568__auto__);
var G__41896 = (0);
seq__41753 = G__41893;
chunk__41754 = G__41894;
count__41755 = G__41895;
i__41756 = G__41896;
continue;
} else {
var obj = cljs.core.first(seq__41753__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.tools.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__41897 = cljs.core.next(seq__41753__$1);
var G__41898 = null;
var G__41899 = (0);
var G__41900 = (0);
seq__41753 = G__41897;
chunk__41754 = G__41898;
count__41755 = G__41899;
i__41756 = G__41900;
continue;
}
} else {
...
var len__5769__auto___41916 = arguments.length;
var i__5770__auto___41917 = (0);
while(true){
if((i__5770__auto___41917 < len__5769__auto___41916)){
args__5775__auto__.push((arguments[i__5770__auto___41917]));

var G__41918 = (i__5770__auto___41917 + (1));
i__5770__auto___41917 = G__41918;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.tools.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq41800){
