...
var G__54791 = request;
var G__54792 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__54791,G__54792) : ajax.formats.get_format.call(null,G__54791,G__54792));
} else {
...
return cljs.core.some((function (p1__54800_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__54800_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__54811){
var map__54813 = p__54811;
var map__54813__$1 = cljs.core.__destructure_map(map__54813);
var request = map__54813__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54813__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__54824 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__54824.cljs$core$IFn$_invoke$arity$1 ? fexpr__54824.cljs$core$IFn$_invoke$arity$1(response) : fexpr__54824.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__54829){
var map__54830 = p__54829;
var map__54830__$1 = cljs.core.__destructure_map(map__54830);
var request = map__54830__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54830__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__54828_SHARP_){
return ajax.formats.get_accept_entries(request,p1__54828_SHARP_);
