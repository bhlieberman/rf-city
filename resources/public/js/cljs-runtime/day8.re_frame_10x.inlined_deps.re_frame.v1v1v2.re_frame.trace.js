...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__20032){
var map__20034 = p__20032;
var map__20034__$1 = cljs.core.__destructure_map(map__20034);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20034__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20034__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20034__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20034__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__20035_20065 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__20036_20066 = null;
var count__20037_20067 = (0);
var i__20038_20068 = (0);
while(true){
if((i__20038_20068 < count__20037_20067)){
var vec__20051_20069 = chunk__20036_20066.cljs$core$IIndexed$_nth$arity$2(null,i__20038_20068);
var k_20070 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20051_20069,(0),null);
var cb_20071 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20051_20069,(1),null);
try{var G__20055_20072 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_20071.cljs$core$IFn$_invoke$arity$1 ? cb_20071.cljs$core$IFn$_invoke$arity$1(G__20055_20072) : cb_20071.call(null,G__20055_20072));
}catch (e20054){var e_20073 = e20054;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_20070,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_20073], 0));
}

var G__20074 = seq__20035_20065;
var G__20075 = chunk__20036_20066;
var G__20076 = count__20037_20067;
var G__20077 = (i__20038_20068 + (1));
seq__20035_20065 = G__20074;
chunk__20036_20066 = G__20075;
count__20037_20067 = G__20076;
i__20038_20068 = G__20077;
continue;
} else {
var temp__5804__auto___20078 = cljs.core.seq(seq__20035_20065);
if(temp__5804__auto___20078){
var seq__20035_20079__$1 = temp__5804__auto___20078;
if(cljs.core.chunked_seq_QMARK_(seq__20035_20079__$1)){
var c__5568__auto___20080 = cljs.core.chunk_first(seq__20035_20079__$1);
var G__20081 = cljs.core.chunk_rest(seq__20035_20079__$1);
var G__20082 = c__5568__auto___20080;
var G__20083 = cljs.core.count(c__5568__auto___20080);
var G__20084 = (0);
seq__20035_20065 = G__20081;
chunk__20036_20066 = G__20082;
count__20037_20067 = G__20083;
i__20038_20068 = G__20084;
continue;
} else {
var vec__20056_20085 = cljs.core.first(seq__20035_20079__$1);
var k_20086 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20056_20085,(0),null);
var cb_20087 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20056_20085,(1),null);
try{var G__20060_20088 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_20087.cljs$core$IFn$_invoke$arity$1 ? cb_20087.cljs$core$IFn$_invoke$arity$1(G__20060_20088) : cb_20087.call(null,G__20060_20088));
}catch (e20059){var e_20089 = e20059;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_20086,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_20089], 0));
}

var G__20090 = cljs.core.next(seq__20035_20079__$1);
var G__20091 = null;
var G__20092 = (0);
var G__20093 = (0);
seq__20035_20065 = G__20090;
chunk__20036_20066 = G__20091;
count__20037_20067 = G__20092;
i__20038_20068 = G__20093;
continue;
}
} else {
}
