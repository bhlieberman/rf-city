...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k25790,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k25790,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__25819){
var vec__25821 = p__25819;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25821,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25821,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__25789){
var self__ = this;
var G__25789__$1 = this;
return (new cljs.core.RecordIter((0),G__25789__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this25791,other25792){
var self__ = this;
var this25791__$1 = this;
return (((!((other25792 == null)))) && ((((this25791__$1.constructor === other25792.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25791__$1.children,other25792.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25791__$1.__extmap,other25792.__extmap)))))));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k25790){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k25790);

}
}));

(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__25789){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__25866 = cljs.core.keyword_identical_QMARK_;
var expr__25867 = k__5352__auto__;
if(cljs.core.truth_((pred__25866.cljs$core$IFn$_invoke$arity$2 ? pred__25866.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__25867) : pred__25866.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__25867)))){
return (new rewrite_clj.node.forms.FormsNode(G__25789,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__25789),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__25789){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__25789,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__25796){
var extmap__5385__auto__ = (function (){var G__25930 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__25796,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__25796)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__25930);
} else {
return G__25930;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__25796),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
