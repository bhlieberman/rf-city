...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__26935 = cljs.core.get_global_hierarchy;
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__26936_SHARP_){
var _STAR_delimiter_STAR__orig_val__26937 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__26938 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__26938);

try{return rewrite_clj.parser.core.parse_next(p1__26936_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__26937);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___26961 = arguments.length;
var i__5770__auto___26962 = (0);
while(true){
if((i__5770__auto___26962 < len__5769__auto___26961)){
args__5775__auto__.push((arguments[i__5770__auto___26962]));

var G__26963 = (i__5770__auto___26962 + (1));
i__5770__auto___26962 = G__26963;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__26945){
var vec__26946 = p__26945;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26946,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq26940){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26941,G__26942,G__26943,seq26940__$3);
}));
...
var G__26954 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__26954)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__26954)){
...
return cljs.core.cons((function (){var G__26959 = rewrite_clj.reader.peek(reader);
switch (G__26959) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__26954)){
