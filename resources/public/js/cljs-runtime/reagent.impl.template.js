...
var G__22502 = o;
reagent.impl.template.goog$module$goog$object.set(G__22502,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22503 = o;
reagent.impl.template.goog$module$goog$object.set(G__22503,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22504 = props;
var G__22504__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22504,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22504);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22504__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22505 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22505,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22505;
}
})(),id_class);
...
var G__22506 = (cljs.core.count(argv) - first_child);
switch (G__22506) {
case (0):
...
var vec__22507 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22507,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22507,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22507,(2),null);
...
var temp__5808__auto___22729 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22729 == null)){
} else {
var key_22731 = temp__5808__auto___22729;
...
var temp__5808__auto___22735 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22735 == null)){
} else {
var key_22738 = temp__5808__auto___22735;
...
var temp__5808__auto___22744 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22744 == null)){
} else {
var key_22747 = temp__5808__auto___22744;
...
var temp__5808__auto___22761 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22761 == null)){
} else {
var key_22764 = temp__5808__auto___22761;
...
var temp__5808__auto___22767 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22767 == null)){
} else {
var key_22768 = temp__5808__auto___22767;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22566_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22566_SHARP_);
}),s));
});
...
break;
default:
var G__22775 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22776 = compiler;
v = G__22775;
compiler = G__22776;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22640 = (function (opts,id,fn_to_element,parse_fn,meta22641){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22640.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22642,meta22641__$1){
var self__ = this;
var _22642__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22640(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22641__$1));
}));

(reagent.impl.template.t_reagent$impl$template22640.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22642){
var self__ = this;
var _22642__$1 = this;
return self__.meta22641;
}));

(reagent.impl.template.t_reagent$impl$template22640.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22640.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22640.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22640.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22640.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22640.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22641","meta22641",-2101747305,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22640.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22640.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22640");

(reagent.impl.template.t_reagent$impl$template22640.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22640");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22640.
 */
reagent.impl.template.__GT_t_reagent$impl$template22640 = (function reagent$impl$template$__GT_t_reagent$impl$template22640(opts,id,fn_to_element,parse_fn,meta22641){
return (new reagent.impl.template.t_reagent$impl$template22640(opts,id,fn_to_element,parse_fn,meta22641));
});
...
return (new reagent.impl.template.t_reagent$impl$template22640(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
