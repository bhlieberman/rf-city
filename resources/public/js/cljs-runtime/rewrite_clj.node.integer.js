...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k25781,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k25781,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__25804){
var vec__25806 = p__25804;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25806,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25806,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__25780){
var self__ = this;
var G__25780__$1 = this;
return (new cljs.core.RecordIter((0),G__25780__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this25782,other25783){
var self__ = this;
var this25782__$1 = this;
return (((!((other25783 == null)))) && ((((this25782__$1.constructor === other25783.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25782__$1.value,other25783.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25782__$1.base,other25783.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this25782__$1.__extmap,other25783.__extmap)))))))));
}));
...
var abs_value = (function (){var G__25853 = self__.value;
if((self__.value < (0))){
return (- G__25853);
} else {
return G__25853;
...
var prefix = (function (){var G__25858 = cljs.core.long$(self__.base);
switch (G__25858) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k25781){
var self__ = this;
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__25780){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__25872 = cljs.core.keyword_identical_QMARK_;
var expr__25873 = k__5352__auto__;
if(cljs.core.truth_((pred__25872.cljs$core$IFn$_invoke$arity$2 ? pred__25872.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__25873) : pred__25872.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__25873)))){
return (new rewrite_clj.node.integer.IntNode(G__25780,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__25872.cljs$core$IFn$_invoke$arity$2 ? pred__25872.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__25873) : pred__25872.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__25873)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__25780,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__25780),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__25780){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__25780,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__25784){
var extmap__5385__auto__ = (function (){var G__25904 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__25784,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__25784)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__25904);
} else {
return G__25904;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__25784),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__25784),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
